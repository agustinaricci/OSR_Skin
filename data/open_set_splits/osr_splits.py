osr_splits = {
    ...
    ####################################################################################################################
    # FITZPATRICK 17K
    # 01_BENIGN_DERMAL 02_BENIGN_EPIDERMAL 03_BENIGN_MELANOCYTE 04_GENODERMATOSES 05_INFLAMMATORY 06_MALIGNANT_CUTANEOUS_LYMPHOMA 07_MALIGNANT_DERMAL 08_MALIGNANT_EPIDERMAL 09_MALIGNANT_MELANOMA
    'fitzpatrick17k': [
        [0, 1, 2,       5, 6, 7, 8], # Unknown classes:  04_GENODERMATOSES 05_INFLAMMATORY
        #[                     7, 8], # S2 known: stroma and tumor
        #[               5 ,   7, 8], # S3 known: muscle, stroma and tumor
     ],
}
